...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.encoders = nn.ModuleList([
            SwitchSequential(nn.Conv1d(1, 320, kernel_size=3, padding=1)),
            SwitchSequential(ResidualBlock(320, 320), AttentionBlock(8, 40)),
            SwitchSequential(ResidualBlock(320, 320), AttentionBlock(8, 40)),
            SwitchSequential(nn.Conv1d(320, 320, kernel_size=3, stride=2, padding=1)),
            SwitchSequential(ResidualBlock(320, 640), AttentionBlock(8, 80)),
            SwitchSequential(ResidualBlock(640, 640), AttentionBlock(8, 80)),
            SwitchSequential(nn.Conv1d(640, 640, kernel_size=3, stride=2, padding=1)),
            ...
            SwitchSequential(nn.Conv1d(1280, 1280, kernel_size=3, stride=2, padding=1)),
